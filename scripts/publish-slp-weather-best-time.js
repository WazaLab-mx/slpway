...
<div class="speakable bg-gradient-to-br from-orange-50 to-amber-50 border-2 border-orange-200 rounded-2xl p-6 md:p-8 mb-10">
  <p class="text-base md:text-lg text-gray-800 leading-relaxed">
    ${t(
      '<strong>Short answer:</strong> visit the city October–April (dry, clear, 21–27°C days); do the Huasteca waterfalls November–March (turquoise water, before the late-dry-season lows); expect the hottest sun in May, the heaviest rain in September, and near-freezing dawns December–February.',
      '<strong>Respuesta corta:</strong> visita la ciudad de octubre a abril (seco, despejado, días de 21–27°C); haz las cascadas de la Huasteca de noviembre a marzo (agua turquesa, antes de los niveles mínimos del estiaje); espera el sol más fuerte en mayo, la lluvia más intensa en septiembre y madrugadas casi heladas de diciembre a febrero.'
    )}
  </p>
</div>
