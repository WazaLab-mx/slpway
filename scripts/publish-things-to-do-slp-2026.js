...
const SECTIONS = [
  {
    ...
    items: [
      ...
      ['4', 'Teatro de la Paz', 'Teatro de la Paz',
        "Built 1889–1894 under the Porfiriato by architect José Noriega and inaugurated on December 4, 1894 with Donizetti's Lucrezia Borgia, its dome was fabricated in Paris. It still hosts orchestras, ballet and theater — check the current program and see a show inside one of Mexico's great historic theaters.",
        "Construido entre 1889 y 1894 durante el porfiriato por el arquitecto José Noriega e inaugurado el 4 de diciembre de 1894 con Lucrezia Borgia de Donizetti; su cúpula se fabricó en París. Sigue programando orquestas, ballet y teatro — revisa la cartelera y vive una función en uno de los grandes teatros históricos de México."],
      ['5', 'Ride the tourist tranvía', 'Súbete al tranvía turístico',
        "A ~1-hour panoramic loop past the Cathedral, San Agustín, San Miguelito and the Calzada, departing every ~30 minutes from beside the Jardín de San Juan de Dios. Two operators run the route and published prices vary (roughly MX$50–120) — confirm when boarding. More arrival-day ideas in our <a href='/visit-san-luis-potosi' class='text-orange-600 underline font-semibold'>visitor guide</a>.",
        "Un recorrido panorámico de ~1 hora por la Catedral, San Agustín, San Miguelito y la Calzada, con salidas cada ~30 minutos junto al Jardín de San Juan de Dios. Dos operadores cubren la ruta y los precios publicados varían (aprox. $50–120) — confirma al abordar. Más ideas para tu primer día en nuestra <a href='/visit-san-luis-potosi' class='text-orange-600 underline font-semibold'>guía del visitante</a>."],
  ...
  },
  {
    ...
    items: [
      ...
      ['10', 'Museo Nacional de la Máscara', 'Museo Nacional de la Máscara',
        "Mexico's national mask collection fills the 19th-century Palacio Martí on Plaza del Carmen — ritual and dance masks from across the country. Entry is MX$20 general, MX$10 students/kids/INAPAM (verified July 2026); hours vary by day, roughly 10 AM–6 PM Tue–Fri with shorter Mon and weekend schedules.",
        'La colección nacional de máscaras llena el decimonónico Palacio Martí en la Plaza del Carmen — máscaras rituales y de danza de todo el país. La entrada cuesta $20 general, $10 estudiantes/niños/INAPAM (verificado julio 2026); el horario cambia por día, aprox. 10:00–18:00 de mar–vie con horarios más cortos lunes y fin de semana.'],
      ['11', 'Museo Federico Silva', 'Museo Federico Silva',
        "A museum devoted to contemporary sculpture — rare in Latin America — in a landmark building on Plaza San Francisco's edge (Álvaro Obregón 4). MX$30 general, free on Sundays, closed Tuesdays (verified July 2026).",
        'Un museo dedicado a la escultura contemporánea — rareza en América Latina — en un edificio emblemático junto a la Plaza de San Francisco (Álvaro Obregón 4). $30 general, gratis los domingos, cierra los martes (verificado julio 2026).'],
