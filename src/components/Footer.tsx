      ...
      <div className="container-responsive section-padding relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="relative pl-6">
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:sanluisway@wazalab.mx" className="text-base text-gray-300 hover:text-primary transition-all duration-200 hover:translate-x-1 inline-flex items-center group">
