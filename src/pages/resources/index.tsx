...
export default function ResourcesHubPage() {
  ...
  const guides: GuideCard[] = [
    ...
    {
      id: 'visas-residency-guide',
      title: 'Mexico Visas & Residency Guide',
      description: 'Complete guide to Mexican immigration from SLP: FMM, temporary & permanent residency, 2026 solvency requirements, INM canje, fees, and CURP/RFC.',
      image: '/images/cultura-2.jpg',
      href: '/resources/mexico-visas-residency-san-luis-potosi',
    ...
    {
      id: 'cost-of-living-guide',
      title: 'Cost of Living Guide (2026)',
      description: 'Complete monthly budget guide: neighborhood rents, utilities, groceries, transport, healthcare costs, and detailed line-item breakdowns by lifestyle.',
      image: '/images/pedestrian-street.jpg',
      href: '/resources/cost-of-living-san-luis-potosi',
