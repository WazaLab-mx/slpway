    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        <section className="relative py-16 text-white overflow-hidden">
          <Image
            src="/images/food/street-food-main.jpg"
            alt="Plate of Mexican street tacos with fresh toppings at a food festival"
            fill
            priority
            className="object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-rose-900/80 to-red-800/70" />
